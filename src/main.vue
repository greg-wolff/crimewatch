    ...
    <f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
      ...
      <f7-pages>
        <f7-page>
          <div class="popup popup-addcrime tablet-fullscreen">
            ...
            <f7-list form>
              ...
              <div class="accordion-item">
                ...
                <a href="#" class="color-blue button-fill button">CREATE</a>
              </div>
          ...
          <GmapMap ref="myMap" :center.sync="center" :zoom="zoom" @zoom_changed="zoomUpdate($event)" @idle="recenter()" @center_changed="cen($event)" :options='{ zoomControl: false, streetViewControl: false, disableDoubleClickZoom: true  }' style="width: 100%; height:100%">
